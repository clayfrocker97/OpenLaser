...
**Version 0.1.0-alpha.1 · Alpha documentation**
...
| Package | Contents |
| --- | --- |
| `OpenLaser-0.1.0-alpha.1-windows-x86_64.zip` | 64-bit Windows executable, simulator launcher and documentation |
| `OpenLaser-0.1.0-alpha.1-macos-universal.zip` | Intel / Apple Silicon application, simulator launcher and documentation |
| `OpenLaser-0.1.0-alpha.1-source.zip` | Matching source, embedded UI build and build instructions |
