...
<style>
  ...
  .control-symbol { display:grid; place-items:center; width:56px; height:56px; border:1px solid var(--line); border-radius:17px; color:var(--accent); background:var(--accent-soft); font-size:27px; }
  h1 { font-size:25px; line-height:1.2; letter-spacing:-.025em; overflow-wrap:anywhere; }p { margin:0; font-size:14px; color:var(--ink-2); line-height:1.5; }.control-error { color:var(--stop); }
  button { width:100%; min-height:56px; border-radius:13px; font-size:15px; font-weight:650; cursor:pointer; touch-action:manipulation; }button:disabled { opacity:.4; cursor:default; }
