...
<style>
  ...
  h2 { margin: 0 0 5px; font-size: 20px; } p { margin: 0; } .xml-summary p, .values-heading span { color: var(--ink-3); font-size: 12px; }
  .xml-meta { justify-content: flex-start; gap: 8px 14px; }
  .status-pill { font-size: 12px; font-weight: 600; color: var(--ink-3); white-space: nowrap; } .matched { color: var(--ok); } .mismatch, .warn { color: #b86112; }
  .error, .xml-problem { color: var(--warn); font-size: 12px; overflow-wrap: anywhere; }
  ...
  .xml-search { background: var(--panel-2); color: var(--ink); border: 1px solid var(--line); border-radius: 8px; padding: 10px 12px; font-size: 14px; flex: 1; min-width: 230px; min-height: 44px; }
  .xml-tools .seg button { min-height: 40px; }
  ...
  .xml-nav > button { background: transparent; cursor: pointer; width: 100%; min-height: 44px; text-align: left; display: flex; align-items: center; justify-content: space-between; gap: 10px; padding: 10px; color: var(--ink-3); border: 1px solid transparent; border-radius: 6px; font-size: 12px; line-height: 1.4; }
  ...
  .xml-nav small { font-size: 10px; opacity: .75; }
  .xml-values { min-width: 0; } .values-heading { margin-bottom: 12px; } .values-heading strong { font-size: 16px; }
  .xml-group { border: 1px solid var(--line); border-radius: 8px; margin-bottom: 16px; overflow: hidden; }
  .xml-group h3 { text-transform: none; letter-spacing: normal; color: var(--ink-2); margin: 0; padding: 12px 14px; font-size: 13px; }
  ...
  .xml-label { min-width: 0; } .xml-label strong { font-size: 14px; line-height: 1.5; display: block; font-weight: 600; }
  .xml-label code { display: block; margin-top: 3px; font-size: 11px; color: var(--ink-3); overflow-wrap: anywhere; }
  .xml-label small { display: block; font-size: 10px; color: var(--accent); margin-top: 5px; overflow-wrap: anywhere; }
  .xml-value { background: var(--panel-2); cursor: pointer; min-width: 0; display: flex; gap: 8px; align-items: center; justify-content: space-between; min-height: 44px; border: 1px solid var(--line); border-radius: 6px; padding: 9px 10px; text-align: left; font-size: 12px; font-variant-numeric: tabular-nums; overflow-wrap: anywhere; }
  ...
  .xml-readback { min-width: 0; font-size: 11px; display: grid; gap: 4px; line-height: 1.4; } .xml-readback strong { font-weight: 600; } .xml-readback small { font-size: 10px; color: var(--ink-3); }
  .xml-readback summary { cursor: pointer; color: var(--ink-3); padding: 5px 0; font-size: 10px; } .word { display: grid; gap: 3px; margin: 6px 0; overflow-wrap: anywhere; font-variant-numeric: tabular-nums; } .word code { font-size: 10px; }
