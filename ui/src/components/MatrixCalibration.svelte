...
<style>
  ...
  nav { display:flex; gap:8px; margin-bottom:30px; } nav button { flex:1; display:flex; align-items:center; gap:12px; padding:12px 18px; min-height:58px; border:1px solid var(--line); border-radius:10px; color:var(--ink-3); background:var(--panel-2); text-align:left; font-size:var(--t-base); cursor:pointer; }
  ...
  .bed strong { font-size:var(--t-xl); } .bed span { font-size:var(--t-sm); } .bed small { font-size:var(--t-sm); color:var(--ink-3); } .bed button.measured { border-color:var(--ok); } .bed button.chosen { outline:3px solid var(--accent); outline-offset:3px; }
  ...
  .step-content { padding-top:18px; } h3 { font-size:var(--t-xl); line-height:1.2; margin:12px 0 18px; color:var(--ink); text-transform:none; letter-spacing:normal; } .step-content p { color:var(--ink-3); font-size:var(--t-base); line-height:1.7; margin:0 0 18px; }
  ...
  .measurement { display:grid; grid-template-columns:1fr 1fr; gap:12px; margin:24px 0 14px; } .measurement button { min-height:104px; text-align:left; padding:16px; border:1px solid var(--line); border-radius:10px; background:var(--panel-2); color:var(--ink); cursor:pointer; } .measurement span { display:block; font-size:var(--t-sm); color:var(--ink-3); margin-bottom:12px; } .measurement strong { font-size:var(--t-lg); }
  .step-content dl { margin:25px 0; } dl div { display:flex; justify-content:space-between; gap:15px; padding:13px 0; border-bottom:1px solid var(--line); font-size:var(--t-sm); } dt { color:var(--ink-3); } dd { margin:0; } .error { color:var(--warn); } .step-content .saved { color:var(--ok); margin-top:16px; } header .seg button { min-height:48px; }
