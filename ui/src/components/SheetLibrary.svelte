...
<style>
  ...
  .card-info { padding:16px; display:grid; gap:7px; } .card-info strong { font-size:var(--t-base); overflow-wrap:anywhere; } .card-info span { font-size:var(--t-sm); color:var(--ink-2); } .card-info small { font-size:var(--t-sm); color:var(--ink-3); } em { font-style:normal; font-size:var(--t-sm); color:var(--accent); margin-top:3px; }
  .intro, .empty p { color:var(--ink-3); font-size:var(--t-sm); line-height:1.65; } .empty { max-width:420px; padding:65px 20px; margin:auto; text-align:center; } .empty strong { font-size:var(--t-lg); } .more { display:block; min-height:48px; margin:22px auto 0; } .error { color:var(--warn); }
  .job-search { width:100%; min-height:48px; padding:12px; border:1px solid var(--line); border-radius:8px; background:var(--panel-2); color:var(--ink); margin:12px 0; } .job-choices { display:grid; gap:8px; max-height:50vh; overflow:auto; } .job-choices button { min-height:72px; padding:16px; text-align:left; border:1px solid var(--line); border-radius:9px; background:var(--panel-2); color:var(--ink); cursor:pointer; } .job-choices span { display:block; font-size:var(--t-sm); margin-top:7px; color:var(--ink-3); }
</style>
