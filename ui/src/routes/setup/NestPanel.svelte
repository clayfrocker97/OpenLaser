...
<style>
  ...
  .stock-card > strong { font-size:var(--t-lg); } .stock-card > span:last-child { color:var(--ink-3); font-size:var(--t-sm); line-height:1.7; } .stock-card b { display:block; color:var(--accent); margin-top:2px; } .eyebrow { font-size:var(--t-sm); text-transform:uppercase; letter-spacing:.1em; color:var(--ink-3); }
  ...
  .distances, .rotations { display:grid; grid-template-columns:1fr 1fr; gap:10px; } .value, .rotations button { border:1px solid var(--line); border-radius:9px; background:var(--panel-2); color:var(--ink); text-align:left; padding:15px; cursor:pointer; min-height:74px; } .value span { display:block; color:var(--ink-3); font-size:var(--t-sm); margin-bottom:10px; } .value strong { font-size:var(--t-lg); }
  h3 { margin:24px 0 12px; color:var(--ink-2); text-transform:none; letter-spacing:0; font-size:var(--t-sm); } .rotations strong { font-size:var(--t-sm); } .rotations small { display:block; margin-top:8px; font-size:var(--t-sm); color:var(--ink-3); } .rotations button[aria-pressed="true"] { border-color:var(--accent); color:var(--accent); background:var(--accent-soft); }
  .nest-note { color:var(--ink-3); font-size:var(--t-sm); line-height:1.7; margin:16px 0; } .search-options summary { cursor:pointer; min-height:48px; display:flex; align-items:center; color:var(--ink-3); font-size:var(--t-sm); } .search-options .seg button { min-height:48px; } .primary { min-height:58px; }
  .result-summary { display:grid; gap:10px; padding:18px 0 24px; } .result-summary strong { font-size:var(--t-xl); } .result-summary span { font-size:var(--t-sm); line-height:1.6; color:var(--ink-3); } .preview-pages { display:grid; grid-template-columns:1fr 1fr; gap:10px; max-height:360px; overflow:auto; padding:2px; } .preview-pages button { min-height:84px; padding:14px; text-align:left; border:1px solid var(--line); border-radius:9px; background:var(--panel-2); color:var(--ink); cursor:pointer; } .preview-pages span, .preview-pages small { display:block; font-size:var(--t-sm); margin-top:9px; color:var(--ink-3); } .preview-pages .on { border-color:var(--accent); background:var(--accent-soft); }
  .searching { padding:40px 0; } .searching strong { font-size:var(--t-lg); } .searching p { color:var(--ink-3); font-size:var(--t-sm); } progress { width:100%; accent-color:var(--accent); } .error { color:var(--warn); padding:14px 0; font-size:var(--t-sm); line-height:1.65; } .pick-hint { font-size:var(--t-sm); color:var(--accent); line-height:1.7; } .pick-hint button { min-height:44px; width:100%; margin-top:7px; }
